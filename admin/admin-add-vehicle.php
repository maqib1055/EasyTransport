  ...
  if(isset($_POST['add_veh']))
    {
            ...
            $v_dpic=$_FILES["v_dpic"]["name"];
              $folder="vendor/img/".$v_dpic;
		        move_uploaded_file($_FILES["v_dpic"]["tmp_name"],"../vendor/img/".$_FILES["v_dpic"]["name"]);
            $query="insert into tms_vehicle (v_name, v_pass_no, v_reg_no, v_driver, v_category, v_location, v_dpic,  v_status ) values(?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssss', $v_name, $v_pass_no, $v_reg_no, $v_driver, $v_category,$v_location,$folder, $v_status);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Vehicle Added";
     ...
     <div id="wrapper">
         ...
         <div id="content-wrapper">
             ...
             <div class="container-fluid">
                ...
                $ret="SELECT * FROM tms_driver where d_category = 'Driver' "; //sql code to get to ten trains randomly
                ...
                ?>
                                     ...
                                     <option><?php echo $row->d_fname;?> <?php echo $row->d_lname;?></option>
                                     <?php }?>
                                 </select>
                             </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="v_location" id="exampleFormControlSelect1">
